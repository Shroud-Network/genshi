//! Solana BPF verifier for the Janus framework.
//!
//! This crate provides Solana-specific primitives for verifying Janus proofs
//! on-chain. Architecture:
//!
//! - `verify_prepare()` from `janus-core` handles transcript reconstruction
...
//! whatever state transition the application defines. Janus stays entirely
