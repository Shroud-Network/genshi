...
//!
//! Janus ships a Pedersen commitment scheme on Grumpkin because Grumpkin's
...
//!
//! ## Generator Seeds
//! - G: `SHA256("janus_pedersen_generator_G")` → try-and-increment → Grumpkin point
//! - H: `SHA256("janus_pedersen_generator_H")` → try-and-increment → Grumpkin point
//!
//! # Commitment
//!
...
const GENERATOR_G_DOMAIN: &[u8] = b"janus_pedersen_generator_G";

/// Domain separator for generator H.
const GENERATOR_H_DOMAIN: &[u8] = b"janus_pedersen_generator_H";
...
///
/// Derived from: `SHA256("janus_pedersen_generator_G")` via try-and-increment.
...
///
/// Derived from: `SHA256("janus_pedersen_generator_H")` via try-and-increment.
