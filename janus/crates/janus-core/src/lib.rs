//! # janus-core
//!
//! Core of the Janus dual-VM zero-knowledge proving framework.
//!
//! Janus produces proofs that verify bytewise-identically on both EVM and
...
//! - `wasm32-unknown-unknown` (browser client proving via `janus-wasm`)
...
//! through the framework's gadgets. See the `janus-core` README for an example.
