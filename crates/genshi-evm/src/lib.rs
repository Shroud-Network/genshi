//! EVM verifier generation for the genshi framework.
//!
//! Given a [`genshi_core::proving::prover::VerificationKey`], this crate emits
//! a self-contained Solidity verifier contract that verifies genshi PLONK-KZG
...
//! directory. The library sources live in `crates/genshi-evm/contracts/library/`
...
/// Returns the names of all reusable libraries shipped by genshi-evm.
