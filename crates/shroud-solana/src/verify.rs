...
//! 1. `shroud_core::proving::verifier::verify_prepare()` — transcript + constraint check
...
use shroud_core::proving::prover::{Proof, VerificationKey};
use shroud_core::proving::srs::SRS;
use shroud_core::proving::verifier::verify_prepare;
use shroud_core::proving::serialization::{proof_from_bytes, vk_from_bytes};
...
mod tests {
    ...
    use shroud_core::proving::srs::SRS;
    use shroud_core::proving::serialization::{proof_to_bytes, vk_to_bytes, public_inputs_to_bytes_le};
    ...
    fn test_verify_matches_native() {
        ...
        let native = shroud_core::proving::verifier::verify(&proof, &vk, &pi, &srs);
